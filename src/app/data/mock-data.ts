...
export const mockVictims: Victim[] = [
  {
    ...
    age: 42,
    biography:
      "Líder comunitario y defensor de derechos humanos. Carlos dedicó su vida a trabajar por la paz y el desarrollo rural en Samaná. Era padre de tres hijos y esposo devoto.",
  ...
  },
  {
    ...
    age: 35,
    biography:
      "Maestra de escuela rural y activista social. María Elena dedicó su vida a la educación de los niños en las veredas más alejadas del municipio.",
    location: { lat: 5.42, lng: -75.015 },
  },
  {
    id: "3",
    ...
    age: 28,
    biography:
      "Joven campesino y líder juvenil. José Fernando trabajaba por mejorar las condiciones de vida de las comunidades rurales.",
    location: { lat: 5.41, lng: -75.02 },
  },
  {
    id: "4",
    ...
    age: 38,
    biography:
      "Enfermera comunitaria que brindó atención médica en zonas rurales durante años.",
    location: { lat: 5.425, lng: -75.01 },
  },
  {
    id: "5",
    ...
    age: 45,
    biography:
      "Agricultor y padre de familia, reconocido por su trabajo comunitario.",
    location: { lat: 5.418, lng: -75.012 },
  },
  {
    id: "6",
    ...
    age: 32,
    biography:
      "Comerciante y madre de dos hijos, conocida por su alegría y solidaridad.",
    location: { lat: 5.422, lng: -75.018 },
  },
];
...
export const mockTestimonies: Testimony[] = [
  {
    ...
    content:
      "Carlos era un hombre bueno, siempre pensando en ayudar a los demás. Llevamos 20 años buscándolo y no perderemos la esperanza de encontrarlo. Sus hijos merecen saber qué pasó con su padre.",
    type: "text",
    date: "2024-03-15",
  },
  {
    ...
    content:
      "La desaparición de María Elena dejó un vacío enorme en nuestra comunidad. Era una maestra extraordinaria que inspiraba a todos los niños. Su memoria vive en cada uno de ellos.",
    type: "text",
    date: "2024-02-10",
  },
  {
    ...
    content:
      "Mi hijo José era un joven lleno de vida y esperanza. Trabajaba por un futuro mejor para todos. No descansaré hasta saber la verdad sobre lo que le sucedió.",
    type: "text",
    date: "2024-01-20",
  },
];
...
export const mockMemoryPlaces: MemoryPlace[] = [
  ...
  },
  {
    ...
    name: "Puente del Recuerdo",
    type: "disappearance",
    location: { lat: 5.4361, lng: -75.0099 },
    description: "Último lugar donde fue visto Pedro Antonio Silva",
    victims: ["5"],
  },
];
...
export const mockEvents: Event[] = [
  {
    ...
    description:
      "Encuentro para honrar la memoria de las víctimas de desaparición forzada",
  },
  {
    id: "2",
...
export const mockTimelineEvents: TimelineEvent[] = [
  {
    ...
    description:
      "Años más álgidos del conflicto en la región del Magdalena Caldense",
    category: "historical",
  },
  {
    id: "2",
    ...
    description:
      "Firma del Acuerdo Final para la Terminación del Conflicto en Colombia",
    category: "historical",
  },
  {
    id: "3",
    ...
    description:
      "La Universidad de Caldas inicia el proyecto de memoria histórica",
    category: "sanctuary",
  },
  {
    id: "4",
